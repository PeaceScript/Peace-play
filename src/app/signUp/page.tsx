    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
      <Card className="w-full max-w-md p-6">
        ...
        <CardBody>
          ...
          <button 
            type="button"
            className="w-full flex items-center justify-center gap-2 bg-white border-2 border-gray-300 rounded-xl p-3 text-base font-bold text-gray-800 hover:bg-gray-100 transition-all shadow-md active:scale-95 mt-2"
            onClick={handleGoogleLogin}
            style={{ minHeight: '48px', visibility: 'visible', boxSizing: 'border-box' }}
          >
            ...
            <span style={{ color: '#1f2937' }}>สมัครสมาชิกด้วย Google</span>
          </button>
